...
public enum EClassificationPerformanceMeasure implements IDeterministicPredictionPerformanceMeasure<Integer, ISingleLabelClassification> {
	...
	FALSE_POSITIVES_WITH_1_POSITIVE(new FalsePositives(1)), PRECISION_WITH_1_POSITIVE(new Precision(1)), RECALL_WITH_1_POSITIVE(new Recall(1)), F1_WITH_1_POSITIVE(new F1Measure(1)), MCC_WITH_1_POSITIVE(new MatthewsCorrelationCoefficient(1));
